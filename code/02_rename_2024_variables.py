...
RENAME_MAPPING = OrderedDict(
    [
        ...
        ("Q33_RE", "it_invest_share_recoded_raw"),

        ("Q14", "mgmt_sys_any_raw"),
        ("Q14_1", "mgmt_sys_erp_raw"),
        ("Q14_2", "mgmt_sys_crm_raw"),
        ("Q14_3", "mgmt_sys_scm_raw"),
        ("Q14_4", "mgmt_sys_other_raw"),
        ("Q14_4_ETC", "mgmt_sys_other_text_raw"),

        ("Q17", "iot_use_any_raw"),
        ("Q17_1", "iot_use_security_raw"),
        ("Q17_2", "iot_use_customer_service_raw"),
        ("Q17_3", "iot_use_payment_raw"),
        ("Q17_4", "iot_use_production_process_raw"),
        ("Q17_5", "iot_use_logistics_inventory_raw"),
        ("Q17_6", "iot_use_energy_management_raw"),
        ("Q17_7", "iot_use_smart_building_office_raw"),
        ("Q17_8", "iot_use_other_raw"),
        ("Q17_8_ETC", "iot_use_other_text_raw"),

        ("Q20", "cloud_use_any_raw"),
        ("Q20_1", "cloud_use_email_raw"),
        ("Q20_2", "cloud_use_office_software_raw"),
        ("Q20_3", "cloud_use_finance_accounting_app_raw"),
        ("Q20_4", "cloud_use_erp_raw"),
        ("Q20_5", "cloud_use_crm_raw"),
        ("Q20_6", "cloud_use_security_software_raw"),
        ("Q20_7", "cloud_use_collaboration_software_raw"),
        ("Q20_8", "cloud_use_database_hosting_raw"),
        ("Q20_9", "cloud_use_file_storage_raw"),
        ("Q20_10", "cloud_use_computing_capacity_raw"),
        ("Q20_11", "cloud_use_app_dev_test_deploy_raw"),
        ("Q20_12", "cloud_use_other_raw"),
        ("Q20_12_ETC", "cloud_use_other_text_raw"),

        ("Q23", "data_analysis_use_any_raw"),
        ("Q23_1", "data_analysis_public_data_raw"),
        ("Q23_2", "data_analysis_transaction_data_raw"),
        ("Q23_3", "data_analysis_customer_data_raw"),
        ("Q23_4", "data_analysis_social_media_data_raw"),
        ("Q23_5", "data_analysis_web_data_raw"),
        ("Q23_6", "data_analysis_sensor_data_raw"),
        ("Q23_7", "data_analysis_location_data_raw"),
        ("Q23_8", "data_analysis_satellite_data_raw"),
        ("Q23_9", "data_analysis_other_raw"),
        ("Q23_9_ETC", "data_analysis_other_text_raw"),
